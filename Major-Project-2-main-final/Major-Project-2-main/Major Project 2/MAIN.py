...
def game_startmap1(characters):
    ...
    Player1_Winner = pygame.image.load("Player_1_W.png")
    Player1_Winner = pygame.transform.scale(Player1_Winner, (1000,800))
    Player2_Winner = pygame.image.load("Player_2_W.png")
    Player2_Winner = pygame.transform.scale(Player2_Winner, (1000,800))
    ...
    while Game_Active:
        ...
        if P1.lives == 0:
            Screen1.blit(Player2_Winner, (0,0)) 
        if P2.lives == 0:
            Screen1.blit(Player1_Winner, (0,0))
