...
Classic_surface1 = pygame.image.load(Classic_Sprite.current_image).convert_alpha()
Classic_surface1 = pygame.transform.scale(Classic_surface1, (80, 30))
Classic_surface2 = pygame.image.load(Classic_Sprite.current_image).convert_alpha()
