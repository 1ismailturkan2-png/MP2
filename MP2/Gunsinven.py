...
Classic_surface = pygame.image.load("Classic.png").convert_alpha()
Classic_surface = pygame.transform.scale(Classic_surface, (80, 30))
...
Classic = Guns_Class(Classic_surface, "Classic" ,"Hand Gun", 20, 25, 10**10000)
...
Guns_Dictionary["Classic"] = Classic
