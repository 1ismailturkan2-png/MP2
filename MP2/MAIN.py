...
pygame.time.set_timer(DROP_EVENT, 5000)
...
P1 = Characters("PLAYER 1", player, (300, 200), "Classic")
P2 = Characters("PLAYER 2", player1, (500, 200), "Classic")
...
while Game_Active:
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.QUIT:
            ...
            gun_list = list(Gunsinven.Guns_Dictionary.keys())
